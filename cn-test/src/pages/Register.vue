<template>
  <div class="wrapper">
    <div class="SignUp-box">
      ...
      <div class="input-box">
        <input type="text" id="username" class="input-form" required />
        <label for="username" id="label">Username</label>
      </div>
      <div class="input-box">
        <input type="password" id="password" class="input-form" required />
        <label for="password" id="label"> Create Password</label>
      </div>
      <div class="input-box">
        <input type="password" id="password" class="input-form" required />
        <label for="password" id="label"> Confirm Password</label>
      </div>
      <div class="input-box">
        <input type="submit" class="input-submit" value="Confirm" />
      </div>
      <div class="register">
        <span>Already have an account? <RouterLink class="rLink" to="/SignIn">Sign In</RouterLink></span>
      </div>
    </div>
  </div>
</template>
